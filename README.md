# ![Logo](https://github.com/ms-engineer-bc24-06/SyncEra/blob/readme/versionup/SyncEra/docs/img/white_1.png)
...
### [SyncEra/docs ディレクトリへ保存](https://github.com/ms-engineer-bc24-06/SyncEra/tree/readme/versionup/SyncEra/docs)
...
- SyncEra/docs ディレクトリ><br>
  プロダクト要求仕様書 (pdr.md)><br>[関係資料（issue の調査）](https://github.com/ms-engineer-bc24-06/SyncEra/tree/readme/versionup/SyncEra/docs/pdr.md)
