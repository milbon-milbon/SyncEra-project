      ...
      <div className='flex flex-col items-center justify-center p-3 bg-white max-w-4xl mx-auto'>
        ...
        <div className='flex flex-col md:flex-row gap-8 w-full mb-8'>
          <div className='flex-1 border rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow'>
            <h2 className='text-2xl font-semibold mb-4 text-center bg-white text-[#003366] border-b-2 border-[#66b2ff]'>
              月額
            </h2>
            <p className='text-center font-bold text-2xl mb-4 text-[#003366]'>¥1,000/ 月</p>
          ...
          <div className='flex-1 border rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <p className='text-center font-bold text-2xl mb-4 text-[#003366]'>¥12,000 / 年</p>
            <ul className='space-y-2'>
              <li className='flex items-center'>
                <span className='flex justify-center items-center w-6 h-6 bg-white border border-[#66b2ff] rounded-full mr-2'>
                  <svg
