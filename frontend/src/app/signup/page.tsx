...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      clientLogger.info('==== ランダムパスワードが生成されました==== ');
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen p-4 bg-white'>
      ...
      >
        ...
        <div className='mb-4'>
          <label className='block text-[#003366] text-[17px] font-bold mb-2' htmlFor='companyName'>
            社名・団体名
          </label>
          <input
            type='text'
        ...
        <div className='mb-4 flex space-x-4'>
          <div className='w-1/2'>
            <label className='block text-[#003366] text-[17px] font-bold mb-2' htmlFor='lastName'>
              氏
            </label>
            <input
              type='text'
          ...
          <div className='w-1/2'>
            <label className='block text-[#003366] text-[17px] font-bold mb-2' htmlFor='firstName'>
              名
            </label>
            <input
              type='text'
        ...
        <div className='mb-10'>
          <label className='block text-[#003366] text-[17px] font-bold mb-2' htmlFor='email'>
            メールアドレス
          </label>
          <input
            type='email'
...
//       // 直接Stripeの決済ページにリダイレクト
//       router.push('/pricing');
//       clientLogger.info('==== pricing ページへの遷移が完了しました==== ');
//     } catch (error) {
//       clientLogger.error(`エラーが発生しました: ${error}`);
//     }
//   };
