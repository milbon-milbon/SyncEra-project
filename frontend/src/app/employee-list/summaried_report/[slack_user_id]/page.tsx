...
export default function SummaryPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <aside className="w-64 bg-[#003366] text-white">
        <div className="p-6">
          <img src="/image/SyncEra(blue_white).png" alt="SyncEra Logo" className="h-12 mb-8" />
          <nav className="space-y-6">
            <Link
              href="/employee-list"
              className="block text-lg hover:text-[#66B2FF] transition-colors duration-300"
            >
              社員一覧
            </Link>
            <Link
              href="/employee-list/summary/123"
              className="block text-lg hover:text-[#66B2FF] transition-colors duration-300"
            >
              日報へ戻る
            </Link>
        ...
        <div className="p-6 mt-auto">
          <Link
            href="/login"
            className="block w-full bg-[#66B2FF] text-white py-2 px-4 rounded text-center font-bold hover:bg-blue-500 transition-colors duration-300"
          >
            ログアウト
          </Link>
        </div>
        ...
        <div className="max-w-6xl mx-auto flex">
          ...
          <div className="w-1/2 pl-4">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {generatedSummary && (
                <div className="mt-4">
                  <h3 className="text-xl font-semibold text-[#003366] mb-2">生成されたサマリー</h3>
                  <div className="bg-gray-100 p-4 rounded mb-4">
